      ...
      <main className={`transition-opacity duration-1000 ${isInvitationOpen ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section className="h-screen flex flex-col items-center justify-center bg-[url('/7.png')] bg-cover bg-center relative">
          ...
          <div className="relative z-10 text-center text-white px-4">
            ...
            <h1 className="font-great-vibes text-6xl md:text-8xl mb-4">Sopiyudin & Salwa</h1>
        ...
        <section className="py-24 px-6 text-center bg-white">
          <div className="max-w-2xl mx-auto">
            ...
            <p className="font-sans text-gray-600 leading-relaxed mb-12">
              Kami mengundang Anda untuk turut berbagi kebahagiaan dan dengan hormat mengharapkan kehadiran Anda pada pernikahan Sopiyudin & Salwa. Bersama keluarga kami, kami menantikan sebuah malam yang penuh cinta, tawa, dan perayaan.
            </p>
            ...
            <div className="grid md:grid-cols-2 gap-12 mb-16">
              ...
              <div className="p-4">
                ...
                <p className="font-sans text-invitation-dark font-medium">Kp. Ceger RT.001/03 Dusun 02</p>
                <p className="font-sans text-gray-500 text-sm mt-1">Ds. Muktiwari Kec. Cibitung</p>
                <p className="font-sans text-gray-500 text-sm">Kab. Bekasi</p>
              </div>
            </div>
        ...
        <footer className="bg-invitation-dark text-invitation-cream py-16 text-center">
           ...
           <p className="font-great-vibes text-3xl mb-4">Sopiyudin & Salwa</p>
